...
<body>
	<div class="q-nav-profile">
		...
		<ul class="q-board">
			...
			<li class="m-4"><a href="${cPath}/generateQ.do"><span class="q-board-span">문제 생성</span> </a></li>	
			...
			<li class="m-4"><a href="${cPath}/generateP.do"><span
					>문단 및 문제 생성</span> </a></li>
			<li class="m-4"><a href="${cPath}/login.do"><span class="q-board-span">문제 생성</span> </a></li>
